...
//  Lors de la soummission des résultats
...
// Si c'est bon on met en vert, sinon rose
function couleursFonction(tabValBool) {

    for(let j = 0; j < tabValBool.length; j++){

        if(tabValBool[j] === true){
            toutesLesQuestions[j].style.background-color = 'lightgreen';
            
        } else {
            toutesLesQuestions[j].style.background-color = '#ffb8b8';
